...
function Schema(name, settings) {
    ...
    adapter.initialize(this, function () {
        ...
        _this.adapter.log = function (query, start) {
            schema.log(query, start);
        };

        _this.adapter.logger = function (query) {
            var t1 = Date.now();
            var log = this.log;
            return function (q) {
                log(q || query, t1);
    ...
    this.callAdapter = function (method) {
        ...
        var adapterMethod = schema.adapter[method];
...
Schema.prototype.define = function defineClass(className, properties, settings) {
    ...
    Object.keys(AbstractClass.prototype).forEach(function (key) {
    ...
    NewClass.registerProperty = function (attr) {
        ...
        Object.defineProperty(NewClass.prototype, attr, {
            ...
            set: function set(value) {
                ...
                if (value === null || value === undefined || (typeof DataType === 'undefined' ? 'undefined' : _typeof(DataType)) === 'object') {
...
function standartize(properties) {
    Object.keys(properties).forEach(function (key) {
        ...
        if (typeof v === 'function' || (typeof v === 'undefined' ? 'undefined' : _typeof(v)) === 'object' && v && v.constructor.name === 'Array') {

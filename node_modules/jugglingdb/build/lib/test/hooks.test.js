    ...
    describe('lifecycle', function () {
        ...
        it('should describe create sequence', function (done) {
            User.create(function () {
                life.should.eql(['afterInitialize', 'beforeValidate', 'afterValidate', 'beforeCreate', 'beforeSave', 'afterSave', 'afterCreate']);
                done();
            });
        });
